...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/letsapi/appUser/">用户信息列表</a></li>
		<li class="active"><a href="${ctx}/letsapi/appUser/form?id=${appUser.id}">用户信息<shiro:hasPermission name="letsapi:appUser:edit">${not empty appUser.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="letsapi:appUser:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="appUser" action="${ctx}/letsapi/appUser/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="letsapi:appUser:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
