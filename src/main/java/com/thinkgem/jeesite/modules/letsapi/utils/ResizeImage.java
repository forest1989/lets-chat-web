...
public class ResizeImage {
    ...
    */
    public BufferedImage getImage(String path) throws IOException{
            ...
            BufferedImage b = javax.imageio.ImageIO.read(f);
        return b;
    }
    /**
     * 把图片写到磁盘上
    ...
    public boolean writeHighQuality(BufferedImage im, String fileFullPath,String imgName2) {
        try {
            /*输出到文件流*/
            FileOutputStream newimage = new FileOutputStream(fileFullPath+imgName2);
    ...
    */
    ...
    public static void main(String[] args) throws Exception{
        ...
        String inputFoler = "E:/src/11.jpg" ; 
         /*这儿填写你存放要缩小图片的文件夹全地址*/
        String outputFolder = "E:/src/";  
        /*这儿填写你转化后的图片存放的文件夹*/
        float times = 0.5f; 
  ...
  /* List<BufferedImage> imageList = r.getImageList(inputFoler,new String[] {"jpg"});
       ...
       /* BufferedImage f=r.getImage(inputFoler);
