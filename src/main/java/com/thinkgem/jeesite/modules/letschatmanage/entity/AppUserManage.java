 ...
 */
package com.thinkgem.jeesite.modules.letschatmanage.entity;
 ...
 * @version 2018-10-17
 */
public class AppUserManage extends DataEntity<AppUserManage> {
	...
	public AppUserManage() {
		super();
	}

	public AppUserManage(String id){
		super(id);
	}
